                                ...
                                <div className='downloadcv' >
                                    <IconContext.Provider value={{ color:"#bcbcbc", className: "global-class-name",  size:'1.5em'}} >
                                        <div className=' d-flex justify-content-center mt-3' >
                                            <p className="float-right">Download CV<a href="https://drive.google.com/file/d/19egNG4fPCF91kRWSAorcPHW6PrNj2d_N/view?usp=sharing" style={{margin: 10}} target="_blank"><GrDocumentPdf /></a></p>
                                        </div>
